...
const Folder = ({
  ...
  return (
    <div className={className}>
      <div
        className={cn('folder-settings node-body', {
          'node-body_disabled': !otherProps.isOn,
        })}
      >
        <div className="button-row folder-settings__actions">
          <Button
            primary
            className="add-file"
            Icon={Icons.AddFile}
        ...
        <Input
          label="Name"
          className="folder-settings__name wmax"
          value={folderName}
        ...
        />
        <h3 className="folder-settings__title">Import and Export</h3>
        <p className="wmax">
        ...
        <h3 className="folder-settings__title">Turn OFF</h3>
        <p className="wmax">
